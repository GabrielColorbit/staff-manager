...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/js/components/employees/Form.vue":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_employees__ = __webpack_require__("./resources/assets/js/services/employees.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  validations: {
    form: {
      ...
      card_id: { minLength: Object(__WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["minLength"])(9), required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"] },
      phone: { minLength: Object(__WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["minLength"])(11), required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"] },
      email: { email: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["email"], required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"] },
      ...
      dependents: { required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"] },
      hired_at: { required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"] },
      fired_at: { required: __WEBPACK_IMPORTED_MODULE_2_vuelidate_lib_validators__["required"] }
    }
  },
  methods: {
    save: function save() {
      ...
      var promisse = this.form.id ? __WEBPACK_IMPORTED_MODULE_1__services_employees__["a" /* default */].put(this.form.id, this.form) : __WEBPACK_IMPORTED_MODULE_1__services_employees__["a" /* default */].post(this.form);
  ...
  mounted: function mounted() {
    ...
    if (id) {
      __WEBPACK_IMPORTED_MODULE_1__services_employees__["a" /* default */].get(id).then(function (response) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-2b249005\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/employees/Form.vue":
/***/ (function(module, exports, __webpack_require__) {
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              !_vm.form.id
                ? _c("span", [_vm._v("Cadastro de Empregados")])
                : _c("span", [_vm._v("Editar Empregado")])
            ]
          ),
          _vm._v(" "),
          _c(
            "el-form",
            { ref: "form", attrs: { model: _vm.form, width: "100%" } },
            [
              _c(
                "el-form-item",
                [
                  ...
                  _c(
                    "el-col",
                    {
                      attrs: {
                        span: 11,
                        offset: 2,
                        error: _vm.$v.form.card_id.$error ? "RG inválido" : ""
                      }
                    },
                    [
                      _c(
                        ...
                        [
                          _c("el-input", {
                            ...
                            attrs: { placeholder: "RG", type: "tel" },
                            on: { blur: _vm.$v.form.card_id.$touch },
                            model: {
                      ...
                      _c(
                        ...
                        [
                          _c("el-input", {
                            ...
                            attrs: { placeholder: "Telefone", type: "tel" },
                            on: { blur: _vm.$v.form.phone.$touch },
                            model: {
                      ...
                      _c(
                        ...
                        [
                          _c("el-input", {
                            ...
                            on: { blur: _vm.$v.form.email.$touch },
                            model: {
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        [
                          _c("el-input", {
                            attrs: { type: "text", placeholder: "Endereço" },
                    ...
                    [
                      _c(
                        "el-form-item",
                        {
                          attrs: {
                            label: "Dependentes",
                            error: _vm.$v.form.dependents.$error
                              ? "Número inválido"
                              : ""
                          }
                        },
                        [
                          _c("el-input-number", {
                            ...
                            on: { blur: _vm.$v.form.dependents.$touch },
                            model: {
                        ...
                        [
                          _c(
                            "el-select",
                            {
                              ...
                              on: { blur: _vm.$v.form.gender.$touch },
                              model: {
                      ...
                      _c(
                        "el-form-item",
                        {
                          attrs: {
                            ...
                            error: _vm.$v.form.hired_at.$error
                              ? "Data inválida"
                              : ""
                          }
                        },
                        [
                          _c("el-date-picker", {
                            ...
                            on: { blur: _vm.$v.form.hired_at.$touch },
                            model: {
                              value: _vm.form.hired_at,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "hired_at", $$v)
                              },
                              expression: "form.hired_at"
                            }
                          })
                        ],
                        1
                    ...
                    [
                      _c(
                        "el-form-item",
                        {
                          attrs: {
                            label: "Data Demissão",
                            error: _vm.$v.form.fired_at.$error
                              ? "Data inválida"
                              : ""
                          }
                        },
                        [
                          _c("el-date-picker", {
                            ...
                            on: { blur: _vm.$v.form.fired_at.$touch },
                            model: {
                              value: _vm.form.fired_at,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "fired_at", $$v)
                              },
                              expression: "form.fired_at"
                            }
                          })
                        ],
                        1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2b249005", module.exports)
  }
}
...
/***/ "./resources/assets/js/components/employees/Form.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-2b249005\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/js/components/employees/Form.vue")
/* template functional */
...
Component.options.__file = "resources/assets/js/components/employees/Form.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2b249005", Component.options)
  } else {
    hotAPI.reload("data-v-2b249005", Component.options)
  }
...
/***/ "./resources/assets/js/services/config.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/assets/js/services/employees.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__factory__ = __webpack_require__("./resources/assets/js/services/factory.js");


/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_0__factory__["a" /* default */])("employees"));

/***/ }),

/***/ "./resources/assets/js/services/factory.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config__ = __webpack_require__("./resources/assets/js/services/config.js");
...
function defaults(config) {
  var _store$getters$auth = __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getters.auth,
      email = _store$getters$auth.email,
      password = _store$getters$auth.password;
...
/* harmony default export */ __webpack_exports__["a"] = (function (url) {
  var service = __WEBPACK_IMPORTED_MODULE_0_axios___default.a.create(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* default */]);
  ...
  return {
    ...
    delete: function _delete(id, config) {
      return service.delete(url + "/" + id, defaults(config));
    },
    head: function head(config) {
    ...
    put: function put(id, data, config) {
      return service.put(url + "/" + id, data, defaults(config));
    },
    patch: function patch(id, data, config) {
