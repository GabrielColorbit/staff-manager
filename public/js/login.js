...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app__ = __webpack_require__("./resources/assets/js/app.js");
...
var app = new __WEBPACK_IMPORTED_MODULE_2__app__["a" /* default */]({
  ...
  validations: {
    form: {
      email: { email: __WEBPACK_IMPORTED_MODULE_0_vuelidate_lib_validators__["email"], required: __WEBPACK_IMPORTED_MODULE_0_vuelidate_lib_validators__["required"] },
      password: { minLength: Object(__WEBPACK_IMPORTED_MODULE_0_vuelidate_lib_validators__["minLength"])(4), required: __WEBPACK_IMPORTED_MODULE_0_vuelidate_lib_validators__["required"] }
    }
  },
  computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapGetters */])(["auth", "loggedIn"])),
  methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])(["login"]), {
    onSubmit: function onSubmit(event) {
      ...
      if ($error) {
        ...
        this.$alert("Verifique s dados do formulário e tente novamente", "Erro no formulário", {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actions__ = __webpack_require__("./resources/assets/js/store/actions.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getters__ = __webpack_require__("./resources/assets/js/store/getters.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vuex_dist_logger__ = __webpack_require__("./node_modules/vuex/dist/logger.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vuex_persistedstate__ = __webpack_require__("./node_modules/vuex-persistedstate/dist/vuex-persistedstate.es.js");
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_3_vuex__["a" /* default */].Store({
  plugins: [__WEBPACK_IMPORTED_MODULE_5_vuex_dist_logger___default()(), Object(__WEBPACK_IMPORTED_MODULE_6_vuex_persistedstate__["a" /* default */])()],
  modules: {
...
var mutations = (_mutations = {}, _defineProperty(_mutations, __WEBPACK_IMPORTED_MODULE_0__mutation_types__["a" /* LOGIN */], function (state, auth) {
  state.auth = auth;
}), _defineProperty(_mutations, __WEBPACK_IMPORTED_MODULE_0__mutation_types__["b" /* LOGOUT */], function (state) {
...
var actions = {
  login: function login(_ref, auth) {
    var commit = _ref.commit,
        state = _ref.state;

    commit(__WEBPACK_IMPORTED_MODULE_0__mutation_types__["a" /* LOGIN */], auth);
  },
  logout: function logout(_ref2) {
    var commit = _ref2.commit;

    commit(__WEBPACK_IMPORTED_MODULE_0__mutation_types__["b" /* LOGOUT */]);
  }
};
